...
<img src="images/create_repo/create_repo1.png" height=100%>

---
# Create a Repository on GitHub (Repo)

<img src="images/create_repo/create_repo2.png" width= "550">

---
# Create a Repository on GitHub (Repo)

![create repo](images/create_repo/create_repo3.png)

---
#  Create a Repository on GitHub (Repo)

<img src="images/create_repo/create_repo4.png" height=100%>

---
# Copy Repo Link

<img src="images/create_repo/add_rstudio1.png" height=100%>


---
# Add Repo into RStudio

<img src="images/create_repo/add_rstudio2.png" height=100%>
...
<img src="images/create_repo/add_rstudio3.png" height=100%>
...
<img src="images/create_repo/add_rstudio4.png" height=100%>
...
<img src="images/local_change/modify_local1.png" height=100%>

---
# Making Local Changes

<img src="images/local_change/modify_local2.png" height=100%>
...
# Stage and Commit
.center[
<img src="images/stage_commit/stage_commit1.png">
]
---
# Stage and Commit
.center[
<img src="images/stage_commit/stage_commit2.png">
]
---
# Stage and Commit
.center[
<img src="images/stage_commit/stage_commit3.png">
]
---
# Pull
.center[
<img src="images/push_pull/pull.png">
]
---
# Push
.center[
<img src="images/push_pull/push.png">
]
---
# Sign RStudio into Github
.center[
<img src="images/push_pull/push_signin.png" height="550">
]
---
# Sign RStudio into Github
.center[
<img src="images/push_pull/push_signin2.png" height= "550">
]
---
# Changes Now Visible on Github
.center[
<img src="images/local_change/github_changes.png" height=100%>
]
---
# Changes Now Visible Locally Too
.center[
<img src="images/local_change/local_changes.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/clone_desktop1.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/clone_desktop2.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/clone_desktop3.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/pull_desktop.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/stage_desktop.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/commit_desktop.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/push_desktop.png" height=100%>
]
...
.center[
<img src="images/clone_desktop/match_desktop.png" height=100%>
]
...
pagedown::chrome_print(input = "02-Productivity.html", timeout = 1000)
```
